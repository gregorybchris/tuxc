...
import MAP_09_SPY_LINE from "./maps/09-spy-line.json";
...
import MAP_FRESH_POND_2_LAPS from "./maps/fresh-pond-2-laps.json";
...
export const MAPS = new Map<string, RunMap>([
  ...
  ["fresh-pond-2-laps", MAP_FRESH_POND_2_LAPS],
